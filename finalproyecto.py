...
test.title("Proyecto final")
test.geometry("500x500") #esto determina el espacio

test.configure(bg='beige')
...
def meusdados():
    ...
    marca3.place(x=10,y=50)
    marca3.configure(bg="beige")
    marca4=Label(test,text=customer.email)
    marca4.place(x=190,y=50)
    marca4.configure(bg="beige")
    marca5=Label(test,text=customer.carnet)
    marca5.place(x=10,y=70)
    marca5.configure(bg="beige")
